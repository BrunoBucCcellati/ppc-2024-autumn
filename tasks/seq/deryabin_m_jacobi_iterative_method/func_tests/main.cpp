...
TEST(deryabin_m_jacobi_iterative_method_seq, test_simple_matrix) {
  // Create data
  vector<double> input_matrix_ {1, 2, 3, 1, 2, 3, 1, 2, 3};
  vector<double> input_right_vector_ {3, 6, 9};
  vector<double> output_x_vector_ = vector<double>(3, 0);
  vector<double> true_solution {1, 1, 1}
...
TEST(deryabin_m_jacobi_iterative_method_seq, test_triangular_matrix) {
  // Create data
  vector<double> input_matrix_ {16, 1, 2, 3, 4, 5, 0, 31, 6, 7, 8, 9, 0, 0, 34, 10, 11, 12, 0, 0, 0, 28, 13, 14, 0, 0, 0, 0, 16, 15, 0, 0, 0, 0, 0, 17};
  vector<double> input_right_vector_ {86, 202, 269, 261, 170, 102};
  vector<double> output_x_vector_ = vector<double>(6, 0);
  vector<double> true_solution {1, 2, 3, 4, 5, 6}
...
TEST(deryabin_m_jacobi_iterative_method_seq, test_diagonal_elements_are_much_larger_than_non-diagonal) {
  // Create data
  vector<double> input_matrix_ {999, 1, 2, 3, 4, 5, 6, 999, 7, 8, 9, 10, 11, 12, 999, 13, 14, 15, 16, 17, 18, 999, 19, 20, 21, 22, 23, 24, 999, 25, 26, 27, 28, 29, 30, 999};
  vector<double> input_right_vector_ {1069, 2162, 3244, 4315, 5375, 6424};
  vector<double> output_x_vector_ = vector<double>(6, 0);
  vector<double> true_solution {1, 2, 3, 4, 5, 6}
...
TEST(deryabin_m_jacobi_iterative_method_seq, invalid_matrix_zeros_on_diagonal) {
  // Create data
  vector<double> input_matrix_ {0, 1, 2, 3, 4, 5, 6, 0, 7, 8, 9, 10, 11, 12, 0, 13, 14, 15, 16, 17, 18, 0, 19, 20, 21, 22, 23, 24, 0, 25, 26, 27, 28, 29, 30, 0};
  vector<double> input_right_vector_ {70, 164, 247, 319, 380, 430};
  vector<double> output_x_vector_ = vector<double>(6, 0);
...
TEST(deryabin_m_jacobi_iterative_method_seq, invalid_matrix_non_strict_diaganol_predominance) {
  // Create data
  vector<double> input_matrix_ {15, 1, 2, 3, 4, 5, 6, 40, 7, 8, 9, 10, 11, 12, 65, 13, 14, 15, 16, 17, 18, 90, 19, 20, 21, 22, 23, 24, 115, 25, 26, 27, 28, 29, 30, 140};
  vector<double> input_right_vector_ {85, 244, 442, 679, 955, 1270};
  vector<double> output_x_vector_ = vector<double>(6, 0);
