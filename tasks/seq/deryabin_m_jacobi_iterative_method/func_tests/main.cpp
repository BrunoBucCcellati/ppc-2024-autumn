...
TEST(deryabin_m_jacobi_iterative_method_seq, test_triangular_matrix) {
  // Create data
  vector<double> input_matrix_{16, 1, 2,  3,  4,  5,  0, 31, 6, 7,  8,  9,
...
TEST(deryabin_m_jacobi_iterative_method_seq,
  ...
  // Create data
  vector<double> input_matrix_{999, 1,   2,  3,   4,  5,   6,  999, 7,
...
TEST(deryabin_m_jacobi_iterative_method_seq, invalid_matrix_zeros_on_diagonal) {
  // Create data
  vector<double> input_matrix_{0,  1,  2,  3,  4,  5,  6,  0,  7,  8,  9,  10,
