...
bool deryabin_m_jacobi_iterative_method_mpi::JacobiIterativeMPITaskParallel::run() {
  ...
  //if (world.rank() == 0) {
    ...
    //boost::mpi::gather(world, 1.0, output_x_vector_, 0);
  ...
  //}
  boost::mpi::gather(world, 1.0, v, 0);
  //boost::mpi::gatherv(world, local_input_matrix_part_.data() + world.rank(), sendcounts[world.rank()], output_x_vector_.data(), sendcounts, 0);
